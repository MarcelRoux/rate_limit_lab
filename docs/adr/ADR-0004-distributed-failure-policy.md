...
This policy toggle is scoped to the M3.2 per-request hybrid model. Longer outage/degraded-mode consolidation is deferred to M3.5 (docs/backlog/0002_hybrid_limiter_backend_outage_semantics.md, docs/backlog/0004_distributed_keyed_limiter_revision.md).
