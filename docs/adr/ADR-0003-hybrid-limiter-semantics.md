...
This ADR applies to the M3.2 per-request hybrid composition only. Consolidated lease/refill semantics are intentionally deferred to M3.5 (docs/backlog/0002_hybrid_limiter_backend_outage_semantics.md).
